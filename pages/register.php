...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($email != $emailConfirm) {
    ...
    try {
      ...
      $message = "Conta criada com sucesso! <a href='../index.php' style='color: #4CAF50;'>Faça login aqui.</a>";
    } catch (PDOException $e) {

      if ($e->errorInfo[1] == 1062) {
        $message = "Erro: Já existe uma conta com este E-mail, Usuário ou CPF.";
      } else {
  ...
  <div class="container">
    ...
    <main class="main-container">
      <?php if (!empty($message)): ?>
        <p style="background-color: #333; color: white; padding: 10px; text-align: center; border-radius: 5px; margin-bottom: 15px;">
          <?php echo $message; ?>
        </p>
      <?php endif; ?>
